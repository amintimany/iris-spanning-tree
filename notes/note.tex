...
\and
\inferH{CInv-cancell}{\knowInv{N, \kappa}{I} \star \cinvown(\kappa, 1) \vdash \knowInv{N, \kappa}{I} \star I}{}
\end{mathpar}
...
finite maps and \Coqe{(g !! x) = Some v}
simply states that the children of node \Coqe{x} in graph \Coqe{g} are
represented by the value \Coqe{v}.
\begin{Coq}
